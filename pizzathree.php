...
<body>
    ...
    if(isset($_SESSION['loggedin'])){
      if($_SESSION['loggedin']=="true"){
        include "connect.php";
        $que = "SELECT * FROM `pizzas` LIMIT 3 offset 6";
   ...
   <div class="image-container">
    ...
    <div class="col-md-8">
      <div class="card-body">
        ...
        <form action = "add_cart3.php" method="POST">
...
<input type="hidden" name="Pizza_img" value="'.$row['pimg'].'">
          <p class="card-text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" class="btn btn-primary" name="acart3" id ="acart3" value="Add To Cart"></p>
        </form>
        <br>
         <form action="fullpizza3.php" method="post"> 
  <input type="hidden" name="Pizza_name" value="'.$row['pname'].'">
