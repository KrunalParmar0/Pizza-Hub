      ...
      <?php 
        ...
        if(isset($_GET['login'])){
            if($_GET['login']=="true"){
              ...
              <strong>Sorry</strong> Email Already or Confirm Password is Incorrect.
              <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
              </div>';
            }
        }
        if(isset($_GET['isremoved'])){
          if($_GET['isremoved']=="true"){
              echo '<div class="alert alert-success alert-dismissible" role="alert">
            <strong>Pizza</strong> is Removed.
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>';
          }
          else{
              echo '<div class="alert alert-danger alert-dismissible" role="alert">
            <strong>Sorry</strong> Pizza is not Removed.  
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>';
          }
      }
...
<br>
    ...
    <?php
        include "connect.php";
        $que = "SELECT * FROM `pizzas` LIMIT 3 OFFSET 0";
  ...
  <img src="img/'.$row['pimg'].'" class="card-img-fade" 
  alt="...">
    </div>
    </div>
    <div class="col-md-8">
