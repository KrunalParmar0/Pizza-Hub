...
<!-- Modal -->
 ...
 include 'header.php';
   ...
   if(isset($_POST['btns'])){
    ...
    echo '<br><br> <form action = "add_cart3.php" method="POST">
...
<input type="hidden" name="Pizza_img" value="'.$img.'">
    ...
    if(isset($_SESSION['loggedin'])){
      if($_SESSION['loggedin']=="true"){
        echo '<p class="card-text">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" class="btn btn-primary" name="acart3" id ="acart3" value="Add To Cart"></p>
        </form>
      </div>
      </div>
      </div>
